...
struct DigestCompositionTests {
    ...
    func singleEntryShareAppendsNoteWhenIncluded() {
        ...
        #expect(content.map(DigestComposition.renderSingleEntryTextShare) == "Title by Author https://example.com My note")
    }
    ...
    func singleEntryShareOmitsByWhenResolvedAuthorIsEmpty() {
        ...
        #expect(content.map(DigestComposition.renderSingleEntryTextShare) == "Title https://example.com")
    }
    ...
    func singleEntryShareOmitsBlankNoteContent() {
        ...
        #expect(content.map(DigestComposition.renderSingleEntryTextShare) == "Title by Author https://example.com")
    }
}
